...
public Response convertirMoneda(
    ...
    try {
        ...
        // Puedes usar la fecha actual del sistema
        java.time.LocalDate hoy = java.time.LocalDate.now();
        String fecha = hoy.toString(); // formato yyyy-MM-dd

        String resultado = manager.ConvertirMoneda(fecha, monto, tipo);
        ...
        return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                .entity("Error al convertir moneda: " + e.getMessage())
                .build();
    }
}
